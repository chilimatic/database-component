...
namespace chilimatic\lib\Database\Cache\Handler\Storage;
use chilimatic\lib\Database\Sql\Orm\AbstractModel;

/**
 * Class ModelStorage
 * @package chilimatic\lib\Database\Cache\Handler\Storage
 */
class ModelStorage implements \Countable, \Iterator, \Serializable
{
     ...
     * @return string
     */
    public function generateHash(AbstractModel $model, $param = null)
    {
    ...
    public function containsParam(ModelStorageDecorator $storedModel, $param)
    {
        ...
        foreach ($param as $propertyName => $propertyValue) {
            ...
            if ($p->isPublic() && $propertyValue !== $storedModel->{$propertyName}) {
                return false;
            }
